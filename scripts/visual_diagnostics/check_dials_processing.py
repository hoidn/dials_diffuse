...
def extract_spot_positions(reflections, column_name: str = 'xyzobs.px.value') -> List[Tuple[float, float]]:
    """
    ...
    try:
        ...
        with open(info_file, 'w') as f:
            ...
            if experiments:
                ...
                f.write(f"  Crystal space group: {exp.crystal.get_space_group().info()}\n")
        ...
        logger.info(f"dials.reciprocal_lattice_viewer {experiments._experiments[0]._filename} {reflections._filename}")
