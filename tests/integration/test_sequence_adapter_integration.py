...
from diffusepipe.crystallography.still_processing_and_validation import create_default_config
...
if __name__ == "__main__":
    ...
    if success:
        print("\n🎉 SOLUTION FOUND!")
        print("The sequence-based adapter successfully processes these 0.1° oscillation images.")
        print("The issue was that stills_process doesn't work well with oscillation data.")
        print("The manual workflow succeeds because it treats them as sequences, not stills.")
    else:
