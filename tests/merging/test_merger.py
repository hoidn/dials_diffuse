...
class TestDiffuseDataMerger:
    ...
    def test_weighted_merge_uniform_weights(self, merger):
        ...
        scaled_observations = [(100.0, 10.0), (120.0, 5.0), (80.0, 20.0)]
    ...
    def test_merge_scaled_data_basic(
        self, merger, mock_scaling_model, sample_binned_data, merge_config
    ):
    ...
    def test_merge_scaled_data_minimum_observations(
        self, merger, mock_scaling_model, sample_binned_data
    ):
    ...
    def test_merge_scaled_data_outlier_rejection(self, merger, mock_scaling_model):
        ...
        config = {
            "outlier_rejection": {"enabled": True, "sigma_threshold": 2.0},
            "minimum_observations": 1,
            "weight_method": "inverse_variance",
        }

        voxel_data = merger.merge_scaled_data(binned_data, mock_scaling_model, config)
